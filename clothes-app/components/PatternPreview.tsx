...
function createColorMap(baseColors: [number, number, number][], colorants: string[]): number[] {
...
export default function PatternPreview({
    ...
    useEffect(() => {
        ...
        const img = new Image();
        img.src = URL.createObjectURL(selectedPattern as File);
        img.onload = () => {
            ...
            for (let i = 0; i < imageData.data.length; i += 4) {
                ...
                const associated_color = colorants[colormapping[index]];
                imageData.data[i+0] = associated_color.R;
                imageData.data[i+1] = associated_color.R;
                imageData.data[i+2] = associated_color.R;
    ...
    }, [baseColors, colorants, patternFile, selectedPattern]);
